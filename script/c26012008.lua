...
function c26012008.initial_effect(c)
	...
	e1:SetTarget(c26012008.sptg)
	e1:SetOperation(c26012008.spop)
	c:RegisterEffect(e1)
	--Attach "Blue Quarky"
...
function c26012008.spfilter(c,e,tp,zone)
	return c:IsCode(26012002) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP,tp,zone)
end
function c26012008.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c26012008.spfilter,tp,LOC,0,1,nil,e,tp,zone) end
...
function c26012008.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=Duel.SelectMatchingCard(tp,c26012008.spfilter,tp,LOCATION_HAND|LOCATION_GRAVE ,0,1,1,nil,e,tp,zone):GetFirst()
